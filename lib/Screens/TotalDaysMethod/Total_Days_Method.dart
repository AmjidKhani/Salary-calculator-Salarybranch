...
class _TotalDaysState extends State<TotalDays> {
  ...
  Widget build(BuildContext context) {
    ...
    onPressed: () {
    if(NSController.text.isNotEmpty&& PDController.text.isNotEmpty&&ResController.text.isNotEmpty) {
    insertData(NSController.text, PDController.text,PLController.text,WOController.text, FController.text,TDController.text,ResController.text,);
    ...
    insertData(String Net_Sallary, String Predent_Days,String Paid_Leaves,String Weekly_Off,String Festival,String Total_Days ,String ResController) {
      String key = databaseRef
          .child("Another_Total_Days Recorde")
          .child("list_Of Recorde")
          .push()
          .key;
      databaseRef.child("Total_Days_Methode").child("list_Of Recorde").child(
          key).set({
        'id': key,
